...
namespace MedicalRecordsData.Migrations
{
    ...
    [Migration("20240402131415_madetreatmentIdnullableforvisitrepository")]
    partial class madetreatmentIdnullableforvisitrepository
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedicalRecordsData.Entities.AuthEntity.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ResumptionDate")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SalaryDomiciledBank")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MedicalRecordsData.Entities.AuthEntity.EmployeePrivilegeAccess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("EmployeePrivilegeAccesses");
                });

            modelBuilder.Entity("MedicalRecordsData.Entities.AuthEntity.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MedicalRecordsData.Entities.AuthEntity.RolePrivilegeAccess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("RolePrivilegeAccess");
                });

            modelBuilder.Entity("MedicalRecordsData.Entities.AuthEntity.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MedicalRecordsData.Entities.MedicalRecordsEntity.AssignPatientBed", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("BedAssignDate")
                        .HasColumnType("datetime2");

                    b.Property<int>("BedId")
                        .HasColumnType("int");

                    b.Property<DateTime>("BedUnAssignDate")
                        .HasColumnType("datetime2");

                    b.Property<int>("PatientAssignedId")
                        .HasColumnType("int");

                    b.Property<string>("PatientAssignedName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("PatientAssignedUserId")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("UnAssignerUserId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.ToTable("AssignPatientBeds");
                });

            modelBuilder.Entity("MedicalRecordsData.Entities.MedicalRecordsEntity.Bed", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MedicalRecordsData.Entities.MedicalRecordsEntity.Clinic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MedicalRecordsData.Entities.MedicalRecordsEntity.CustomerFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MedicalRecordsData.Entities.MedicalRecordsEntity.NurseNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MedicalRecordsData.Entities.MedicalRecordsEntity.PatientHmo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("HMOPackageId")
                        .HasColumnType("int");

                    b.Property<int>("HMOProviderId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PatientHMOCardDocumentUrl")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("PatientHMOId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedicalRecordsData.Entities.MedicalRecordsEntity.PatientReferrer", b =>
                {
                    ...
                    b.Property<int>("ReferredClinicId")
                        .HasColumnType("int");

                    b.Property<string>("ReferrerNote")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MedicalRecordsData.Entities.Resources", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MedicalRecordsData.Entities.AuthEntity.EmployeePrivilegeAccess", b =>
                {
                    b.HasOne("MedicalRecordsData.Entities.AuthEntity.Employee", "Employee")
                        .WithMany("EmployeePrivilegeAccesses")
            ...
            modelBuilder.Entity("MedicalRecordsData.Entities.AuthEntity.RolePrivilegeAccess", b =>
                {
                    b.HasOne("MedicalRecordsData.Entities.AuthEntity.Role", "Role")
                        .WithMany("RolePrivilegeAccesses")
            ...
            modelBuilder.Entity("MedicalRecordsData.Entities.MedicalRecordsEntity.PatientReferrer", b =>
                {
                    b.HasOne("MedicalRecordsData.Entities.MedicalRecordsEntity.Clinic", "Clinic")
                        .WithMany()
            ...
            modelBuilder.Entity("MedicalRecordsData.Entities.MedicalRecordsEntity.Treatment", b =>
                {
                    ...
                    b.HasOne("MedicalRecordsData.Entities.MedicalRecordsEntity.Visit", "Visit")
                        .WithOne("Treatment")
                        .HasForeignKey("MedicalRecordsData.Entities.MedicalRecordsEntity.Treatment", "VisitId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
